...
public class StartGame extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        techList.add("大象 Dà xiàng");
        techList.add("八 Bā");
        techList.add("五 Wǔ");
        techList.add("果汁 Guǒ zhī");
        techList.add("巧克力 Qiǎo kè lì");
        techList.add("三角形 Sān jiǎo xíng");
        techList.add("长方形 Cháng fang xíng");
        techList.add("猫 Māo");
        techList.add("鱼 Yú");
        techList.add("十二 Shí' èr");
        techList.add("炸鸡 Zhá jī");
        techList.add("汉堡包 Hàn bǎo bāo");
        techList.add("意大利面 Yì dà lì miàn");
        techList.add("西瓜 Xī guā");
        techList.add("南瓜 Nán guā");
        techList.add("头发 Tóu fǎ");
        // Put all the technology names with technology image resource ids in map.
        map.put(techList.get(0), R.drawable.elephant);
        map.put(techList.get(1), R.drawable.eight1);
        map.put(techList.get(2), R.drawable.five);
        map.put(techList.get(3), R.drawable.juice);
        map.put(techList.get(4), R.drawable.chocolate);
        map.put(techList.get(5), R.drawable.triangle);
        map.put(techList.get(6), R.drawable.rectangle);
        map.put(techList.get(7), R.drawable.cat);
        map.put(techList.get(8), R.drawable.fish);
        map.put(techList.get(9), R.drawable.twelve);
        map.put(techList.get(10), R.drawable.friedchicken);
        map.put(techList.get(11), R.drawable.burger);
        map.put(techList.get(12), R.drawable.spaghetti);
        map.put(techList.get(13), R.drawable.watermelon);
        map.put(techList.get(14), R.drawable.pumpkin);
        map.put(techList.get(15), R.drawable.hair);
